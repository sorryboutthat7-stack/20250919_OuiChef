...
const UNSPLASH_ACCESS_KEY = Constants.expoConfig?.extra?.EXPO_PUBLIC_UNSPLASH_ACCESS_KEY;
const UNSPLASH_API_URL = 'https://api.unsplash.com/search/photos';

// Debug: Log environment variable status
console.log('Image Service - Environment check:');
console.log('EXPO_PUBLIC_UNSPLASH_ACCESS_KEY exists:', !!Constants.expoConfig?.extra?.EXPO_PUBLIC_UNSPLASH_ACCESS_KEY);
console.log('Unsplash Key first 8 chars:', Constants.expoConfig?.extra?.EXPO_PUBLIC_UNSPLASH_ACCESS_KEY ? Constants.expoConfig.extra.EXPO_PUBLIC_UNSPLASH_ACCESS_KEY.substring(0, 8) : 'NOT FOUND');
