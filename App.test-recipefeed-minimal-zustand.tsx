...
// Create a minimal Zustand store for testing
interface TestStore {
  pantryItems: string[];
  filters: { mealType: string };
}

const useTestStore = create<TestStore>((set) => ({
  pantryItems: ['pasta', 'tomatoes', 'onions'],
...
export default function App() {
  ...
  // Use minimal Zustand store
  const { pantryItems, filters } = useTestStore();
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.debugText}>Pantry items: {pantryItems.length}</Text>
          <Text style={styles.debugText}>Filters: {JSON.stringify(filters)}</Text>
        </View>
      </View>
    );
  }
